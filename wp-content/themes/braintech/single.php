                ...
                <div class="row padding-<?php echo esc_attr( $col_letf) ?>">
                    <div class="col-lg-<?php echo esc_attr( $col_side). ' ' .esc_attr( $col_letf) ?>">
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            <?php
                            if (!empty($braintech_option['blog-thum-image-single'])){?>                                                   
                                <?php } else { ?>
                            ...
                            <?php } else { ?>
                                    <ul class="single-posts-meta">
                                        ...
                                        <?php if(!empty($braintech_option['admin-link'])){ ?>
                                        <li>
                                            <span class="p-user">                                        
                                                <i class="fa fa-user-o" aria-hidden="true"></i> <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php echo esc_html($display_name); ?></a>
                                            </span>
                                        </li> 
                                        <?php } else { ?>
                                            <li>
