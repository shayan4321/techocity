...
//End Preloader settings  
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array( 
                array(
                    ...
                    'type'     => 'switch', 
                    'title'    => esc_html__('Hide Banner', 'braintech'),
                    'subtitle' => esc_html__('You can hide banner here', 'braintech'),
                    'default'  => false,
                ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(                            
            ...
            array(
                'id'               => 'blog-thum-image-single',
                'type'             => 'switch',
                'title'            => esc_html__('Hide Thumbnail Image', 'braintech'),                   
                'desc'             => esc_html__('You can show/hide Thumbnail Image at blog page', 'braintech'),
                'default'          => false,
            ),
        ...
        'fields'           => array(
            ...
            array(
                ...
                array(
                    ...
                    'type'     => 'switch', 
                    'title'    => esc_html__('Show Team Single Biography & Professional Skills', 'braintech'),
                    'subtitle' => esc_html__('You Can Show Biography & Professional Skills', 'braintech'),
                    'default'  => true,
                ), 
                ...
                array(
                    'id'       => 'show-team-cta',
                    'type'     => 'switch', 
                    'title'    => esc_html__('Show Team Single Cta', 'braintech'),
                    'subtitle' => esc_html__('You Can Show Cta', 'braintech'),
                    'default'  => true,
                ),                         
            )
        ) 
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                array(
                    'id'       => 'show-portfolio-cta',
                    'type'     => 'switch', 
                    'title'    => esc_html__('Show Portfolio Single Cta', 'braintech'),
                    'subtitle' => esc_html__('You Can Show Cta', 'braintech'),
                    'default'  => true,
                ), 
            )
    ...
    'fields' => array(
                ...
                array(
                    ...
                    'default'  => esc_html__( '2022 All Rights Reserved', 'braintech' ),
                ),  
