...
function geschaft_business_custom_styles($custom) {
	...
	wp_add_inline_style( 'geschaft-business-style', $custom );

}

add_action( 'wp_enqueue_scripts', 'geschaft_business_custom_styles' );

//Sanitizes Fonts
function geschaft_business_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
