...
<div id="gb_responsive" class="nav side_gb_nav">
	<nav id="top_gb_menu" class="gb_nav_menu" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'geschaft-business' ); ?>">
		<a href="javascript:void(0)" class="closebtn gb_menu" onclick="geschaft_business_gb_Menu_close()">x<span class="screen-reader-text"><?php esc_html_e('Close Menu','geschaft-business'); ?></span></a>
